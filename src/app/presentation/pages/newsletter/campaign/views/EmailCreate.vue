...
import { AppCard, AppInput } from 'src/app/presentation/components'
import { required, min } from 'src/app/infra/utils/rules'
import StepInfoGeneral from '../components/form/email/StepInfoGeneral.vue'
import StepEmailTemplate from '../components/form/email/StepEmailTemplate.vue'
import StepEmailSetup from '../components/form/email/StepEmailSetup.vue'
